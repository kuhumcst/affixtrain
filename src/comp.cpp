...
static struct rotation goodParms[] = 
    {
        ...
        {{ 0.1021732216,-0.5298420485, 0.8355539585, 0.0025004658, 0.1024159319, 0.0135034591},6,"bg","D",  9556,1,0.19515940},
        ...
        {{ 0.1930245535,-0.4821981014, 0.8318583033, 0.0216216036, 0.1930529303, 0.0223908087},6,"cs","D", 11112,1,0.17103465},
        ...
        {{-0.0004270133,-0.7221318990, 0.6817640089,-0.1065134775,-0.0004766746, 0.0487629587},6,"da","D", 53689,1,0.07890260},
        ...
        {{ 0.0446935086,-0.3023603714, 0.8712477459, 0.2557936479, 0.0447718118, 0.2829720055},6,"el","S", 61986,1,0.09432719},
        ...
        {{ 0.0295695581,-0.6858376245, 0.7258637975, 0.0089433217, 0.0297721711, 0.0301293284},6,"en","D", 11201,2,0.12318150},

        {{-0.0005687963,-0.6946223877, 0.7166924688,-0.0549098036,-0.0003540120, 0.0289155389},6,"es","C", 18456,1,0.09748033},
        ...
        {{ 0.2078542471,-0.4288771669, 0.8345478643, 0.1270351602, 0.2079485197, 0.1304236601},6,"et","D", 20790,0,0.19145894},

        {{ 0.0476291369,-0.6595158821, 0.7455334457, 0.0309211596, 0.0478341347, 0.0608763121},6,"fa","S",  1963,3,0.15233817},
        {{ 0.0023118581,-0.6790274640, 0.7275921544, 0.0149554752, 0.0028828714, 0.0964055916},6,"fa","C",  1971,3,0.15376761},
        ...
        {{ 0.2322447589,-0.4074394521, 0.8454759395, 0.0747928330, 0.2322360204, 0.0754875058},6,"fr","D", 34221,1,0.09875563},
        ...
        {{ 0.0013657790,-0.6741470922, 0.7357042565,-0.0119229210, 0.0013559218, 0.0641800992},6,"is","C",287331,1,0.08705487},

        {{ 0.0006500449,-0.7124017300, 0.6974840179,-0.0751288207, 0.0006206730, 0.0188327467},6,"it","C", 42595,1,0.08523434},

        {{-0.0197892011,-0.7029359285, 0.7067127008,-0.0682898054,-0.0127179756, 0.0349482767},6,"la","E",  7774,1,0.42846498}, // cutoff == 3 is probably to be preferred
        {{-0.0012861551,-0.6999562655, 0.7108840224,-0.0674097817,-0.0007561510, 0.0126027136},6,"la","C",  7750,1,0.43107303}, // cutoff == 3 is probably to be preferred

        {{ 0.0057774324,-0.6732268078, 0.7362387698, 0.0273332853, 0.0059725934, 0.0624658307},6,"mk","S",107080,1,0.07884323},
        {{ 0.0537713922,-0.6225543318, 0.7783935741,-0.0252297864, 0.0537369935, 0.0106760683},6,"mk","C",107643,1,0.07963091},
 ...
 //       {{ 0.139452    ,-0.511179    , 0.830374    , 0.027272    , 0.139112    , 0.098139    },6}, // Dutch     (-XC) (better)
        ...
        {{ 0.0016262062,-0.7090379332, 0.7016664117,-0.0701639737, 0.0016556865, 0.0010425635},6,"pl","C",302734,0,0.07316330},

        {{ 0.1326332335,-0.6279433806, 0.7548159800,-0.0161485532, 0.1326242114, 0.0223252152},6,"pt","S", 70558,1,0.06575459},
        {{-0.0009255873,-0.6707122696, 0.7325781059,-0.0819672647,-0.0005595239, 0.0821861781},6,"pt","C", 70642,1,0.06617960},

        {{-0.021046    ,-0.659149    , 0.741112    ,-0.011371    ,-0.005483    , 0.125192    },6,"ro","E", 50221,1,0.10066098},
        {{ 0.2212514567,-0.4178187162, 0.8504829526, 0.0449211169, 0.2213110412, 0.0464497255},6,"ro","D", 47878,1,0.11131702},
        ...
        {{ 0.0081560789,-0.6936789856, 0.7188250225,-0.0388209278, 0.0083157831, 0.0213848919},6,"ru","C",179299,1,0.10137872},
        ...
        {{ 0.0179669122,-0.6965438108, 0.7157928227,-0.0093251017, 0.0180222526, 0.0416267408},6,"sk","S", 72207,1,0.06571712},

        {{ 0.016221    ,-0.408998    , 0.765411    , 0.330531    , 0.016203    , 0.370256    },6,"sl","C", 30333,0,0.13036071},
        {{ 0.0603373290,-0.6840087393, 0.7239138311,-0.0277666783, 0.0602158002,-0.0065791674},6,"sl","D", 30326,1,0.13124954},
        ...
        {{ 0.0603758783,-0.6567697052, 0.7464491599, 0.0072245730, 0.0603574155, 0.0642397641},6,"sr","C", 29824,1,0.14598299},
        {{ 0.0146026555,-0.4844863176, 0.8364239989, 0.1629106060, 0.0150191535, 0.1966957652},6,"sr","S", 28775,1,0.15225828},

        {{ 0.008000    ,-0.238492    , 0.876932    , 0.278726    , 0.008168    , 0.310311    },6,"uk","C", 32925,1,0.14237366},
        {{ 0.0245488840,-0.0909029197, 0.9162818920, 0.2706077141, 0.0246089256, 0.2787962907},6,"uk","S", 33120,1,0.14241939},
